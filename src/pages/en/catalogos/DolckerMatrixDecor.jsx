...
import {
	AplicacionesMatrixDecor as Aplicaciones,
	CaracteristicasMatrixDecor as Caracteristicas,
	DescargasMatrixDecor as Descargas,
	DisenosMatrixDecor as Disenos,
	DolckerMatrixDecor as Dolcker,
	Final,
	IndiceMatrixDecor as Indice,
	// SistemasDecor as Sistemas,
	VentajasMatrixDecor as Ventajas,
} from "../../../modules/EN";

const DolckerMatrixDecorEn = () => {
	...
	return (
		<MultipleOptionsProvider>
			...
			<Aplicaciones id={["aplicaciones", "portales", "bano", "espacios"]} />
...
export default DolckerMatrixDecorEn;
