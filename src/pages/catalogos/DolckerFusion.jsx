...
import {
	AplicacionesFusion as Aplicaciones,
	CaracteristicasFusion as Caracteristicas,
	DescargasFusion as Descargas,
	DisenosFusion as Disenos,
	DolckerFusion as Dolcker,
	Final,
	IndiceFusion as Indice,
	SistemasFusion as Sistemas,
	VentajasFusion as Ventajas,
} from "../../modules";
...
const DolckerFusion = () => {
	...
	return (
		<MultipleOptionsProvider>
			...
			<Aplicaciones id={["aplicaciones", "terracota", "color", "petra", "textura"]} />
			<Disenos id={["diseno", "formato", "acabados", "espesores", "configurador", "series"]} />
