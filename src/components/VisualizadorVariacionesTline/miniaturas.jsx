...
export const SelectoresFormato = [
  ...
  { id: "80x80", imagen: Formato80x80, name: "80x80" },
];
...
import Modular6 from "../../assets/icons/SelectoresFormato/f.svg";
import Modular9 from "../../assets/icons/SelectoresFormato/j.svg";

export const SelectoresModular = [
  { id: "Modular1", imagen: Modular1, name: "Modular 1" },
  { id: "Modular2", imagen: Modular2, name: "Modular 2" },
  { id: "Modular3", imagen: Modular3, name: "Modular 3" },
  { id: "Modular4", imagen: Modular4, name: "Modular 4" },
  { id: "Modular5", imagen: Modular5, name: "Modular 5" },
  { id: "Modular6", imagen: Modular6, name: "Modular 6" },
