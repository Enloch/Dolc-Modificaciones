    ...
    const miniaturas = [
        {
            ...
            imagen: Imagen1,
            texto: 'DO&BASALT',
            enlace: 'fachadas-ventiladas/dolcker-system#basalt',
        },
        {
            id: 2,
            imagen: Imagen2,
            texto: 'DO&DOLM',
            enlace: 'fachadas-ventiladas/dolcker-system#dolm',
        },
        {
            id: 3,
            imagen: Imagen3,
            texto: 'DO&DQUARTZ',
            enlace: 'fachadas-ventiladas/dolcker-system#dquartz',
        },
        {
            id: 4,
            imagen: Imagen4,
            texto: 'DO&MARBLE',
            enlace: 'fachadas-ventiladas/dolcker-system#marble',
        },
        {
            id: 5,
            imagen: Imagen5,
            texto: 'DO&STONE',
            enlace: 'fachadas-ventiladas/dolcker-system#stone',
        },
        {
            id: 6,
            imagen: Imagen6,
            texto: 'DO&QUARCITY',
            enlace: 'fachadas-ventiladas/dolcker-system#quarcity',
        },
        {
            id: 7,
            imagen: Imagen7,
            texto: 'DO&CRETE',
            enlace: 'fachadas-ventiladas/dolcker-system#crete',
        },
        {
            id: 8,
            imagen: Imagen8,
            texto: 'DO&PORTLAND',
            enlace: 'fachadas-ventiladas/dolcker-system#portland',
        },
        {
            id: 9,
            imagen: Imagen9,
            texto: 'DO&SPACE',
            enlace: 'fachadas-ventiladas/dolcker-system#space',
        },
        {
            id: 10,
            imagen: Imagen10,
            texto: 'DO&TZMENT',
            enlace: 'fachadas-ventiladas/dolcker-system#tzment',
        },
        {
            id: 11,
            imagen: Imagen11,
            texto: 'DO&WOOD',
            enlace: 'fachadas-ventiladas/dolcker-system#wood',
        },
        {
            id: 12,
            imagen: Imagen12,
            texto: 'DO&TERRAZO',
            enlace: 'fachadas-ventiladas/dolcker-system#terrazo',
        },
        {
            id: 13,
            imagen: Imagen13,
            texto: 'DO&ARQUITECT',
            enlace: 'fachadas-ventiladas/dolcker-system#arquitect',
        },
        {
            id: 14,
            imagen: Imagen14,
            texto: 'DO&VOLUMEN',
            enlace: 'fachadas-ventiladas/dolcker-system#volumen',
        },
    ]
