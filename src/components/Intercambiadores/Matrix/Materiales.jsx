import PlataMate from "/texturas/PlataMate.webp";
import PlataGrata from "/texturas/PlataGrata.webp";
import PlataGrataRFP from "/texturas/PlataGrata.webp";
import PlataBrillo from "/texturas/PlataBrillo.webp";
import OroMate from "/texturas/OroMate.webp";
import OroGrata from "/texturas/OroGrata.webp";
import OroGrataRFP from "/texturas/OroGrata.webp";
import BronceMate from "/texturas/BronceMate.webp";
import BronceGrata from "/texturas/BronceGrata.webp";
import BronceGrataRFP from "/texturas/BronceGrata.webp";
import InoxMate from "/texturas/InoxMate.webp";
import InoxGrata from "/texturas/InoxGrata.webp";
import InoxGrataRFP from "/texturas/InoxGrata.webp";
import BurdeosMate from "/texturas/BurdeosMate.webp";
import BurdeosGrata from "/texturas/BurdeosGrata.webp";
import BurdeosGrataRFP from "/texturas/BurdeosGrata.webp";
import NegroGrata from "/texturas/NegroGrata.webp";
import NegroGrataRFP from "/texturas/NegroGrata.webp";
import OlmoRugoso from "/texturas/OlmoRugoso.webp";
import NogalRugoso from "/texturas/NogalRugoso.webp";
import EmberoDoradoRugoso from "/texturas/EmberoDoradoRugoso.webp";
import EmberoTexturaRugoso from "/texturas/EmberoTexturaRugoso.webp";
//minis
...
export const MaterialesMetalizados = [
  ...
  { name: OroMate, roughness: "0.65", metalness: "0.75" },
  { name: OroGrata, roughness: "0.6", metalness: "0.6" },
  { name: OroGrataRFP, roughness: "0.55", metalness: "0.75" },
  { name: BronceMate, roughness: "0.65", metalness: "0.75" },
  { name: BronceGrata, roughness: "0.6", metalness: "0.6" },
  { name: BronceGrataRFP, roughness: "0.55", metalness: "0.75" },
  { name: InoxMate, roughness: "0.65", metalness: "0.75" },
  { name: InoxGrata, roughness: "0.6", metalness: "0.6" },
  { name: InoxGrataRFP, roughness: "0.55", metalness: "0.75" },
  { name: BurdeosMate, roughness: "0.65", metalness: "0.75" },
  { name: BurdeosGrata, roughness: "0.6", metalness: "0.6" },
  { name: BurdeosGrataRFP, roughness: "0.55", metalness: "0.75" },
  { name: NegroGrata, roughness: "0.6", metalness: "0.6" },
  { name: NegroGrataRFP, roughness: "0.55", metalness: "0.75" },
  { name: OlmoRugoso, roughness: "0.6", metalness: "0.2" },
