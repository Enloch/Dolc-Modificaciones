...
const ambientesImports = import.meta.globEager("../../assets/images/Series/CRETE/AMBIENTES/**");

const muestrasImports = import.meta.globEager("../../assets/images/Series/CRETE/DESPIECE/**");

const muestrasBLANCOImports = import.meta.globEager("../../assets/images/Series/CRETE/MUESTRAS_ACABADOS/BLANCO/**");
const muestrasGRISImports = import.meta.globEager("../../assets/images/Series/CRETE/MUESTRAS_ACABADOS/GRIS/**");
const muestrasNEGROImports = import.meta.globEager("../../assets/images/Series/CRETE/MUESTRAS_ACABADOS/NEGRO/**");
const muestrasTAUPEImports = import.meta.globEager("../../assets/images/Series/CRETE/MUESTRAS_ACABADOS/TAUPE/**");
