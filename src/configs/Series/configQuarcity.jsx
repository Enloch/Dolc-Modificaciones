...
const ambientesImports = import.meta.globEager("../../assets/images/Series/QUARCITY/AMBIENTES/**");

const muestrasImports = import.meta.globEager("../../assets/images/Series/QUARCITY/DESPIECE/**");

const muestrasBEIGEImports = import.meta.globEager("../../assets/images/Series/QUARCITY/MUESTRAS_ACABADOS/BEIGE/**");
const muestrasBLACKImports = import.meta.globEager("../../assets/images/Series/QUARCITY/MUESTRAS_ACABADOS/BLACK/**");
const muestrasGRAPHITEImports = import.meta.globEager("../../assets/images/Series/QUARCITY/MUESTRAS_ACABADOS/GRAPHITE/**");
const muestrasGREYImports = import.meta.globEager("../../assets/images/Series/QUARCITY/MUESTRAS_ACABADOS/GREY/**");
