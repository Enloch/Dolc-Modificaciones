...
const ambientesImports = import.meta.globEager("../../../assets/images/Series/WOOD/AMBIENTES/**");

const muestrasImports = import.meta.globEager("../../../assets/images/Series/WOOD/DESPIECE/**");

const muestrasABEDULImports = import.meta.globEager("../../../assets/images/Series/WOOD/MUESTRAS_ACABADOS/ABEDUL/**");
const muestrasENCINAImports = import.meta.globEager("../../../assets/images/Series/WOOD/MUESTRAS_ACABADOS/ENCINA/**");
const muestrasEUCALIPTOImports = import.meta.globEager("../../../assets/images/Series/WOOD/MUESTRAS_ACABADOS/EUCALIPTO/**", {
	eager: true,
});
const muestrasMANZANOImports = import.meta.globEager("../../../assets/images/Series/WOOD/MUESTRAS_ACABADOS/MANZANO/**");
const muestrasSAUCEImports = import.meta.globEager("../../../assets/images/Series/WOOD/MUESTRAS_ACABADOS/SAUCE/**");
