...
const ambientesImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/AMBIENTES/**");

const muestrasImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/DESPIECE/**");

const muestrasBASICPROImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/MUESTRAS_ACABADOS/BASIC PRO/**", {
	eager: true,
});
const muestrasBASICImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/MUESTRAS_ACABADOS/BASIC/**");
const muestrasBEIGEImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/MUESTRAS_ACABADOS/BEIGE/**");
const muestrasPEARLImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/MUESTRAS_ACABADOS/PEARL/**");
const muestrasSILVERImports = import.meta.globEager("../../../assets/images/Series/TERRAZO/MUESTRAS_ACABADOS/SILVER/**");
