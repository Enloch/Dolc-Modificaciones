...
const ambientesImport = import.meta.globEager("../../../assets/images/Series/ARQUITECT/AMBIENTES/**");

const muestrasImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/DESPIECE/**");

const muestrasAMARILLOImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/AMARILLO/**", {
	eager: true,
});
const muestrasAZULImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/AZUL/**");
const muestrasBLANCOImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/BLANCO/**");
const muestrasCENIZAImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/CENIZA/**");
const muestrasGRAFITOImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/GRAFITO/**", {
	eager: true,
});
const muestrasGRISImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/GRIS/**");
const muestrasMALVAImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/MALVA/**");
const muestrasMANGOImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/MANGO/**");
const muestrasNEGROImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/NEGRO/**");
const muestrasROJOImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/ROJO/**");
const muestrasTURQUESAImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/TURQUESA/**", {
	eager: true,
});
const muestrasVERDEImports = import.meta.globEager("../../../assets/images/Series/ARQUITECT/MUESTRAS_ACABADOS/VERDE/**");
