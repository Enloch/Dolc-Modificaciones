...
const backgroundImports = import.meta.glob("../assets/images/Diseno/Formato/backgrounds/**", { eager: true });
const selectImports = import.meta.glob("../assets/icons/SelectoresFormato/**", { eager: true });

const backgrounds = getDataFromModules(backgroundImports);
const selects = getDataFromModules(selectImports);
import formato90x90 from "../assets/images/Diseno/Formato/backgrounds/Dolcker Intercambiador 90x90.png";
const config = {
	fachada: [
		{
			top: "50%",
			...
			menu: {
				...
				selectores: [
					...
					},
					{
						...
						primerPlano: {
							bg: backgrounds[1],
							another: Children.toArray([<SvgComponent className="plano" />, <SvgComponent className="fondo" />]),
						},
						colorPicker: true,
						// menu: {
						//     seleccionado: -1,
