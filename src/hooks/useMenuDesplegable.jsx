...
import BtnIndiceES from "../modules/ES/System/02_Indice/BtnIndice";
import MenuDesplegableES from "../modules/ES/System/02_Indice/MenuDesplegableLanding";
import BtnIndiceFR from "../modules/FR/System/02_Indice/BtnIndice";
import MenuDesplegableFR from "../modules/FR/System/02_Indice/MenuDesplegable";
import BtnIndiceEN from "../modules/EN/System/02_Indice/BtnIndice";
import MenuDesplegableEN from "../modules/EN/System/02_Indice/MenuDesplegable";
import openMenu from "../assets/icons/indice/open-menu.svg";
import closeMenu from "../assets/icons/indice/close-menu.svg";

const useMenuDesplegable = (Lista, titulo, indiceRef, language = "es") => {
	const BtnIndice =
		language === "fr"
			? BtnIndiceFR
			: language === "en"
			...
			const observer = new IntersectionObserver(
				(entries) => {
					...
					if (entries[0].isIntersecting) {
						...
						if (
							window.scrollY <=
							indiceRef.current.offsetTop + indiceRef.current.offsetHeight
						) {
...
export default useMenuDesplegable;
