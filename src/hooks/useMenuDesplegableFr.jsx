...
import BtnIndice from '../modules/ES/System/02_Indice/BtnIndice'
import MenuDesplegable from '../modules/ES/System/02_Indice/MenuDesplegable'
import openMenu from '../assets/icons/indice/open-menu.svg'
import closeMenu from '../assets/icons/indice/close-menu.svg'

const useMenuDesplegableFr = (Lista, titulo, indiceRef) => {
        ...
        if (isOpen) {
            ...
            setMenuDesplegable(
                <MenuDesplegable menuRef={menuRef} setIsOpen={setIsOpen}>
                    ...
                    <Lista isMenuDesplegable={true} fr={true} />
                </MenuDesplegable>
            )
        } else {
...
export default useMenuDesplegableFr
