		...
		<>
			<StyledCaracteristicas id={id[0]} backgroundColor={COLORS.gray02}>
				...
				<Listado>
					...
					<li>
						<strong>Acid-resistant.</strong> Insensitive to the most common
						acids (Does not resist hydrofluoric acid attack).
					</li>
					<li>
					...
					<li>
						<strong>Unalterable.</strong> No problems with hot pots or lit
						cigarettes, which, on the contrary, damage wood, plastic laminates
						or agglomerates with resins.
					</li>
					<li>
					...
					<li>
						<strong>Resistant to ice.</strong> The material is resistant to cold
						and ice.
					</li>
					<li>
						<strong>Stable chromatic.</strong> The colors are totally stable and
						do not change either due to exposure to the sun, atmospheric agents,
						or smog.
					</li>
				</Listado>
				<Text>
					...
					<br />
					<br />
					Does not contain chemical sealers, varnishes or resins, does not emit
					exhalations even with the heat of a flame. Unlike some natural stones,
					it does not emanate Radon or other radioactive gases and is not
					polished with lead. It is produced respecting the environment.
					<br />
					<br />
				...
				<Listado>
					...
					<li>
						It is a product that, due to its electrical insulation capacity,
						prevents the capture of electrically active ambient dust
					</li>
