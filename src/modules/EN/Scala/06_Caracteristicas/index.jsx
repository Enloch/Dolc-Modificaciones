		...
		<>
			<StyledCaracteristicas id={id[0]} backgroundColor={COLORS.gray02}>
				...
				<Text>
					...
					non-existent porosity and, by water absorption less than 0.1 %
					<br />
					<br />
				...
				<Listado>
					...
					<li>
						...
						widespread acids (It does not resist attack by hydrofluoric acid).
					</li>
					<li>
					...
					<li>
						<strong>Non-combustible.</strong> The material does not burn nor
						produce toxic-harmful gases or smoke in case of fire or exposure to
						flames.
					</li>
					<li>
						<strong>
							It does not retain organic substances and bacteria, cause of
							allergies and disturbances.
						</strong>
					</li>
					<li>
						<strong>Easy to work with.</strong> The product lends itself to be
						worked (cut, drilled, etc.) like natural stone to satisfy any type
						of customization.
					</li>
					<li>
						<strong>It is Unattackable.</strong> No problem with hot pots or lit
						cigarettes, which on the contrary damage wood, plastic laminates or
						resin agglomerates.
					</li>
					<li>
						<strong>Easy to clean.</strong> It is possible to use strong
						detergents or solvents without the risk of damaging the material.
					</li>
					<li>
						<strong>Resistant to cold.</strong> The material is resistant to
						cold and ice.
					</li>
					<li>
						<strong>Stable chromatic.</strong> Colors are totally stable and do
						not change due to exposure to the sun, atmospheric agents, or smog.
					</li>
				</Listado>
				<Text>
					...
					resins, it does not emit fumes even with the heat of a flame. Unlike
					some natural stones, it does not emit Radon or other radioactive gases
					and is not polished with lead. It is produced respecting the
					environment.
					<br />
					<br />
				...
				<Listado>
					...
					<li>Resistance to release of own dust</li>
					<li>Easy cleaning of acquired dust</li>
					<li>
						It is a product that, due to its electrical insulating capacity,
						prevents the collection of electrically active environmental dust
					</li>
					<li>Suitable where water use is abundant</li>
					<li>
						It is the definitive installation: it requires no maintenance after
						its installation
					</li>
				</Listado>
			...
			<StyledCaracteristicas id={id[1]} backgroundColor={COLORS.gray02}>
				...
				<Text>
					...
					<br />
					<br />
					Ceramic pieces are classified as dry-pressed ceramic tiles with low
					water absorption according to standard UNE-EN 14411, with the
