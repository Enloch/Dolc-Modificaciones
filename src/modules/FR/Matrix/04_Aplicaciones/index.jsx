	...
	return (
		<>
			<StyledAplicaciones id={id[0]} backgroundColor={COLORS.gray02} rowGap={DISTANCES.small}>
				...
				<ImageWithCaption src={img1} alt="Image des Applications 1" caption="" columnSpan="6" />
				<Cita
			...
			<StyledAplicaciones id={id[1]} backgroundColor={COLORS.gray01} rowGap={DISTANCES.small}>
				...
				<ImageWithCaption src={logos} alt="Image des Applications 1" caption="" columnSpan="6" />
				<Cita
