	...
	return (
		<>
			<StyledGaleria id={id[0]} backgroundColor={COLORS.gray02}>
				...
				<Text>
					Invisifix est l'outil de conception de façades et d'enveloppes développé pour les architectes et techniciens recherchant une
					liberté créative avec des solutions techniques précises.
					<br />
					<br />
					Avec Dolcker Invisifix vous pouvez :
					<br />
					• Concevoir de nouveaux bâtiments ou réhabiliter des façades existantes, en adaptant les finitions aux conditions de
					...
					du bâtiment.
					<br />
					• Choisir des systèmes d'ancrage sur mesure : des systèmes à clips aux pièces faites sur mesure, avec conseil technique inclus
					pour garantir une installation efficace et durable.
					<br />
					<br />
					Dolcker Fusion offre une solution intégrale pour amener la conception architecturale au niveau supérieur, combinant créativité,
