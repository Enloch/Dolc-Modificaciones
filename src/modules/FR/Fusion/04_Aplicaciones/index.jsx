  ...
  return (
    <>
      <StyledGaleria id={id[0]} backgroundColor={COLORS.gray02}>
        ...
        <Text>
          Fusion est l'outil de conception de façades et d'enveloppes développé pour les architectes
          et techniciens recherchant une liberté créative avec des solutions techniques précises.
          <br />
          <br />
          Avec Dolcker Fusion vous pouvez :
          <br />
          • Concevoir de nouveaux bâtiments ou réhabiliter des façades existantes,
          en adaptant les finitions aux conditions urbaines ou au style du projet.
          <br />
          • Combiner des couleurs dans des pourcentages définis par le concepteur,
          générant des compositions uniques en céramique, pierre ou matériaux techniques.
          <br />
          • Sélectionner des textures spécifiques comme mat, brillant ou flammé,
          fournissant un langage esthétique en accord avec l'identité du bâtiment.
          <br />
          • Choisir des systèmes d'ancrage personnalisés : des systèmes à clip aux
          coupes sur mesure, avec conseil technique inclus pour assurer une installation
          efficace et durable.
          <br />
          <br />
          Dolcker Fusion offre une solution intégrale pour emmener la conception architecturale
          au niveau supérieur, combinant créativité, technique et support
          professionnel à chaque phase du projet.
        </Text>
        <Cita
      ...
      <StyledGaleria id={id[1]} backgroundColor={COLORS.gray01}>
        ...
        <Text>
          Fusion Terracota est une ligne de surfaces architecturales qui explore la beauté intemporelle des tons de terre cuite naturels. Conçue pour les projets contemporains qui recherchent un lien avec les matériaux bruts et l'équilibre visuel, cette collection s'adapte aux compositions sobres et expressives.
          <br />
          <br />
          ...
          <br />
          • Surfaces de grande pureté visuelle, conçues pour offrir des textures authentiques et des finitions céramiques chaudes, durables et polyvalentes.
          <br />
          • Possibilité de combiner des couleurs dans des proportions personnalisées, adaptant chaque conception à l'identité esthétique du projet.
          <br />
          • Parfait pour l'architecture contemporaine, la réhabilitation ou l'intégration dans des paysages urbains sensibles.
          <br />
          <br />
          Choisissez les tons directement de la terre et créez des compositions qui parlent le langage de l'architecture honnête, naturelle et essentielle.
        </Text>
        <Cita
      ...
      <StyledGaleria id={id[2]} backgroundColor={COLORS.gray01}>
        ...
        <Text>
          Fusion Color est l'outil créatif de la collection ARQ qui permet de combiner des couleurs monochromes pour obtenir des compositions architecturales personnalisées, équilibrées ou audacieuses, selon l'identité du projet.
          <br />
          <br />
          ...
          <br />
          • Parier sur une grande dispersion chromatique, en jouant avec des couleurs intenses ou contrastées qui génèrent de l'impact et du caractère.
          <br />
          <br />
          Chaque combinaison peut être définie dans la proportion exacte souhaitée, permettant de contrôler le rythme visuel et l'atmosphère de la conception, du plus sobre au plus expressif.
          <br />
          <br />
          Fusion Color transforme la céramique en un outil de langage architectural, où la couleur est structurée, équilibrée et exprimée avec intention.
        </Text>
        <Cita
      ...
      <StyledGaleria id={id[3]} backgroundColor={COLORS.gray01}>
        ...
        <Text>
          Fusion Petra est la proposition créative qui permet de combiner différentes collections de pierres naturelles pour créer des façades uniques, contemporaines et esthétiquement précieuses.
          <br />
          <br />
          Les pierres naturelles, en raison de leur origine géologique et de leur diversité chromatique et graphique, offrent une richesse visuelle inégalée.
          <br />
          <br />
          ...
          <br />
          <br />
          Avec Fusion Petra, les pierres cessent d'être un matériau complémentaire pour devenir un outil de composition central, capable de construire l'identité et la sophistication à partir de l'essentiel.
        </Text>
        <Cita
      ...
      <StyledGaleria id={id[4]} backgroundColor={COLORS.gray01}>
        ...
        <Text>
          Fusion Textura est l'outil créatif qui permet de concevoir et de personnaliser des façades en combinant différentes finitions et couleurs, générant des compositions avec de la profondeur, du rythme visuel et une interaction dynamique avec la lumière.
          <br />
          <br />
          ...
          <br /> <br />
          Fusion Textura offre une liberté créative totale, élevant la façade à un langage expressif où la finition devient une question de conception.
        </Text>
        <Cita
