...
import ConfiguradorImg from '../../../assets/images/DolckerTline/config.webp'
    ...
    return (
        <>
            ...
            <StyledDisenos id={id[3]} backgroundColor={COLORS.gray01}>
                <Titulo2>Acabados Piedra</Titulo2>
                <Anotaciones>
                    <Anotacion
                        type='normal'
            ...
            <StyledDisenos id={id[3]} backgroundColor={COLORS.gray01}>
                <Titulo2>Acabados Cenefa</Titulo2>
                <Anotaciones>
                    <Anotacion
                        type='normal'
                        text='Pulsa en el punto para ver todas las posibilidades de piezas especiales'
            ...
            <StyledDisenos id={id[5]} backgroundColor={COLORS.gray01}>
                ...
                <ImageWithCaption
                    src={InteractivoImg}
                    alt='Imagen de Diseños 1'
                    caption='Rotador Piezas especiales'
                    columnSpan='6'
                />
            </StyledDisenos>
            <StyledDisenos id={id[5]} backgroundColor={COLORS.gray01}>
                ...
                <ImageWithCaption
                    src={img1}
                    alt='Imagen de Diseños 1'
                    caption='Perfiles de todas las piezas (renders y CAD)'
                    columnSpan='6'
                />
            </StyledDisenos>
