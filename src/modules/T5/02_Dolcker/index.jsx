...
'
        ...
        <Text>
          ...
          <br />
          <br />
          El <strong>Sistema DOL-T5 XL</strong> es una solución avanzada para fachadas
          ventiladas, diseñada para la instalación de revestimientos cerámicos de gran
          formato con un sistema de fijación híbrido, combinando grapa oculta y adhesivo
          estructural. Su diseño optimizado garantiza un montaje ligero, seguro y eficiente,
          utilizando materiales de la más alta calidad. Características Principales
          <br />
          <br />
          ...
          <br />
          Juntas horizontales de 5-6 mm y juntas verticales de 2 mm o más, asegurando
          ...
          <br />
          Perfiles verticales en T y L de aluminio extruido, lacados en negro, garantizando
          ...
          <br />
          Tornillería auto-taladrante con arandela de EPDM de acero inoxidable, asegurando
          máxima sujeción.
          <br /> Tornillería auto-taladrante de cabeza plana lacada en acero inoxidable para
          una fijación discreta y resistente.
          <br />
          <br />
          <strong>Fijaciones:</strong>
          <br />
          Fijación mecánica con grapa oculta lacada en acero inoxidable con una salida de
          5,6 mm.
          <br />
          Fijación química con adhesivo estructural SikaTack Panel, asegurando una unión
          fuerte y duradera.
          <br />
          <br />
          <strong>Otros componentes:</strong>
          <br /> Imprimación Sika Primer 210T, optimizando la adherencia del adhesivo.
          <br /> Cinta adhesiva de doble cara, mejorando la fijación inicial y facilitando
          la instalación.
        </Text>
      </div>
