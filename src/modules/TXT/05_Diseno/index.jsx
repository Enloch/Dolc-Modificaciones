  ...
  return (
    <>
      ...
      <StyledDisenos id={id[1]} backgroundColor={COLORS.gray01} isEspesores>
        ...
        <Text>
          • TC 6 – Paneles de gran formato XXL con espesores de 3 mm y 6 mm,
          asegurando máxima estabilidad estructural y un impacto visual
          excepcional.
          <br />
          <br />
          • TC 9 – Grapa vista diseñada para piezas con espesores de 9 mm,
          ofreciendo una sujeción segura y estética.
          <br />
          <br />• TC 11 & TC 14 – Sistema de fijación oculta con ranura
          continua, compatible con espesores de 11 mm y 14 mm, proporcionando un
          acabado limpio y homogéneo.
        </Text>
      </StyledDisenos>
