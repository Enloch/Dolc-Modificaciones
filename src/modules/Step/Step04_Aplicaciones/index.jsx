...
const AplicacionesStep = ({ id }) => {
    return (
        <>
            ...
            >
                <Titulo color={COLORS.gray01}>Aplicaciones Dolcker Step</Titulo>
                <ImageWithCaption
                    src={img1}
            ...
            >
                <Titulo2 color={COLORS.gray01}>Lore ipsum</Titulo2>
                <ImageWithCaption
                    src={img2}
                    alt='Imagen de Aplicaciones 1'
            ...
            <StyledAplicaciones
                ...
                rowGap={DISTANCES.medium}
            >
                <Titulo2 color={COLORS.gray01}>Lore ipsum dolor</Titulo2>
                <ImageWithCaption
                    src={img3}
                    alt='Imagen de Aplicaciones 1'
            ...
            <StyledAplicaciones
                ...
                rowGap={DISTANCES.medium}
            >
                <Titulo3 color={COLORS.gray01}>— Dorime</Titulo3>
                <ImageWithCaption
                    src={img4}
            ...
            >
                <Titulo3 color={COLORS.gray01}>
                    — Duis fringilla ultrices est et pharetra.
                </Titulo3>
                <ImageWithCaption
                    src={img5}
