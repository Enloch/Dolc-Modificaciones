...
const AplicacionesTline = ({ id }) => {
	...
	const imagesRehabilitar = import.meta.globEager("../../../../assets/images/GaleriaArchiform/Aplicaciones/*");
	...
	// Actualizado para usar import.meta.globEager con eager: true en lugar de glob
	const imagesobra = import.meta.globEager("../../../../assets/images/GaleriaArchiform/ObraNueva/*");
	...
	return (
		<>
			<StyledAplicaciones id={id[0]} backgroundColor={COLORS.gray02} rowGap={DISTANCES.medium}>
				...
				<ImageWithCaption src={img1} alt="Imagen de Aplicaciones 1" caption="DOLCKER & CLIP Archiform." columnSpan="6" />
				<Cita
			...
			<StyledAplicaciones id={id[1]} backgroundColor={COLORS.gray01} rowGap={DISTANCES.medium}>
				...
				<ImageWithCaption src={img2} alt="Imagen de Aplicaciones 1" caption="DOL - TC14 Archiform." columnSpan="6" />
				<Cita
			...
			<StyledAplicaciones id={id[2]} backgroundColor={COLORS.gray01} rowGap={DISTANCES.medium}>
				...
				<ImageWithCaption src={img3} alt="Imagen de Aplicaciones 1" caption="DOL -TC20 Archiform." columnSpan="6" />
				<Cita
			...
			<StyledAplicaciones id={id[3]} backgroundColor={COLORS.gray01} rowGap={DISTANCES.medium}>
				...
				<ImageWithCaption src={img4} alt="Imagen de Aplicaciones 4" caption="DOL - TC20 Archiform." columnSpan="6" />
			</StyledAplicaciones>
			<StyledAplicaciones id={id[4]} backgroundColor={COLORS.gray01} rowGap={DISTANCES.medium}>
				...
				<ImageWithCaption src={img5} alt="Imagen de Aplicaciones 5" caption="DOL - TC14 Archiform." columnSpan="6" />
			</StyledAplicaciones>
		</>
	);
};
