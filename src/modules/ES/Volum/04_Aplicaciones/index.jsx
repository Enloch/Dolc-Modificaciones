...
import img1 from "../../../../assets/images/Volumen/Aplicaciones/Volum06.jpg";
import img2 from "../../../../assets/images/Volumen/Aplicaciones/Volum51.jpg";
import img3 from "../../../../assets/images/Volumen/Aplicaciones/Volum39.jpg";
import img4 from "../../../../assets/images/Volumen/Aplicaciones/Volum101.jpg";
import img5 from "../../../../assets/images/Volumen/Aplicaciones/Volum03.jpg";
...
const AplicacionesTline = ({ id }) => {
  ...
  const imagesRehabilitar = import.meta.glob(
    "../../../../assets/images/GaleriaVolumen/Aplicaciones/*",
    { eager: true }
  );
  ...
  const imagesobra = import.meta.glob(
    "../../../../assets/images/GaleriaVolumen/Obra/*",
    { eager: true }
  );
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Cita
          cita="“Una fachada no es solo una piel, es una declaración.”"
      ...
      >
        ...
        />
        <Cita
          cita="“El diseño debe seducir, educar y, quizás lo más importante, provocar una respuesta emocional.”"
