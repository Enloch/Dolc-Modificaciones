...
import Escena3DFusion from "../../../../components/Configuradores/Fusion";
	...
	return (
		<>
			<StyledDisenos id={id[0]} backgroundColor={COLORS.gray02}>
				...
				<ImageWithCaption src={img1} alt="Imagen de Diseños 1" caption="DOLCKER Fusion Color" columnSpan="6" />
				<Cita
