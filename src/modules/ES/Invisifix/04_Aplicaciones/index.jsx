	...
	return (
		<>
			<StyledGaleria id={id[0]} backgroundColor={COLORS.gray02}>
				...
				<Text>
					Invisifix es la herramienta de diseño de fachadas y envolventes desarrollada para arquitectos y técnicos que buscan libertad
					creativa con soluciones técnicas precisas.
					<br />
					<br />
