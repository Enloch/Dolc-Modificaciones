    ...
    <StyledDolcker id={id} backgroundColor={COLORS.gray02}>
      ...
      <div className="dolcker-info">
        ...
        <Text>
          ...
          <strong>con infinitas posibilidades de modulaciones.</strong> El
          sistema DOLCKER permite diseñar fachadas, con soluciones técnicas para
          el desarrollo de suelos elevados, techos, así como recercados de
          ventanas, tapas de coronación, siempre utilizando el mismo material.
          <br />
          <br />
          ...
          <br />
          <br />
          DOLCKER, ha desarrollado 4 sistema de colocación de alta seguridad
          para que los técnicos diseñen edificos singulares.
        </Text>
      </div>
